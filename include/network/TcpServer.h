...
private:
    ...
    void handleUserExists(TcpConnection::pointer connection, const nlohmann::json &data);
    void handleGetPublicKey(TcpConnection::pointer connection, const nlohmann::json &data);
